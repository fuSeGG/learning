...
public class PlayerController : MonoBehaviour {
    ...
    [Range(0, 1)] [SerializeField] private float m_SlideSpeed = 1f;          // Amount of maxSpeed applied to slide movement. 1 = 100%
    ...
    private void FixedUpdate() {
        ...
        if (JumpClimax == true) {
            animator.SetBool("JumpClimax", true);
        }
        ...
        for (int i = 0; i < colliders.Length; i++) {
            ...
            else if (m_JumpForce == 0 && !m_Grounded){
            JumpClimax = true;
            }
        }
    }
